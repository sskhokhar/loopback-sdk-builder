...
exports.describeModels = function describeModels(app) {
    ...
    app.handler('rest').adapter.getClasses().forEach(function(c) {
        //console.log(c.sharedClass.ctor.settings);
        ...
        c.sharedClass.ctor.settings.sdk = Object.assign({ enabled: true },
            c.sharedClass.ctor.settings.sdk
        );
        // Tell SDK to blacklist specific methods
        c.sharedClass.ctor.settings.sdk.blacklist = Object.assign({}, // Will we want to add methods to blacklist by default???
