...
module.exports = function generate(ctx) {
        ...
        console.log("loopback models: ", Object.keys(ctx.models));
        if (ctx.excludeModels.length > 0) {
            var exlude = ctx.excludeModels.split(",");
            console.log("models to exclude: ", ctx.excludeModels)
        ...
        console.log("models after exclusion: ", Object.keys(ctx.models));
        /**
